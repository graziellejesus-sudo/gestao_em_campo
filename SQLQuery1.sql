...
/* Relacionamento entre Solicita��o e Usu�rio */
...
/* Relacionamento entre Solicita��o e Escala */
ALTER TABLE Solicitacoes
...
VALUES
('Ana Souza', 'ana.souza@email.com', '12345678', 'Funcion�rio'),
('Carlos Oliveira', 'carlos.oliveira@email.com', '87654321', 'Funcion�rio'),
('Mariana Santos', 'mariana.santos@email.com', '11223344', 'Gestor'),
('Jo�o Pereira', 'joao.pereira@email.com', '55667788', 'Funcion�rio'),
...
('2026-09-08', '2026-09-14', 'N�o', 1),
('2026-09-15', '2026-09-21', 'N�o', 1),
('2026-09-22', '2026-09-28', 'N�o', 1),
('2026-09-29', '2026-10-05', 'N�o', 0);
